...
void SerialTask::init() {
	...
	MenuHandler* heating_settings= new MenuHandler();
	heating_settings->addFunctions("modbus_id", check_modbus_id);
	heating_settings->addFunctions("modbus_register_address", check_modbus_register_address);
	heating_settings->addFunctions("modbus_register_number", check_modbus_register_number);
	...
	setparams->addSideMenus("modbus_config", heating_settings);
