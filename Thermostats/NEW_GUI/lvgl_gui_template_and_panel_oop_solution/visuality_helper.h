#pragma once
#ifndef VISUALITY_HELPER_H
#define VISUALITY_HELPER_H
...
class visuality_helper{
    ui_anim_user_data_t * user_data; /* data */
public:
    visuality_helper(/* args */);
    ~visuality_helper();
